...
(
    ...
    CONSTRAINT [FK_ProfessionalAreas_Professionals_ProfessionalId] FOREIGN KEY ([ProfessionalId]) REFERENCES [dbo].[Professionals] ([Id]),
    CONSTRAINT [FK_ProfessionalAreas_Areas_AreaId] FOREIGN KEY ([AreaId]) REFERENCES [dbo].[Areas] ([Id]), 
